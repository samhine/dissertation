...
p.save(filename = 'plots/test/8x9_heat_in_model7_1epoch_2.png', height=5, width=10, units = 'in', res=1000)
...
p2.save(filename = 'plots/test/8x9_heat_out_model7_1epoch_2.png', height=5, width=10, units = 'in', res=1000)
...
p2.save(filename = 'plots/test/8x9_heat_out_ideal_model7_1epoch_2.png', height=5, width=10, units = 'in', res=1000)
...
p.save(filename = 'plots/test/8x9_heat_inter_model7_1epoch_2.png', height=5, width=3.33, units = 'in', res=1000)
